<div class="absolute inset-0 flex h-full w-full flex-col lg:flex-row">
    ...
    <div class="lg:max-w-96 flex max-h-full flex-shrink-0 flex-col justify-between bg-gray-900/60 p-4 text-gray-300 lg:p-7">
        <div class="flex flex-1 flex-col gap-y-4">
            ...
            <p class="text-sm lg:text-base">{{ $task->prompt }}</p>
            <div

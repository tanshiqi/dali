    ...
    <div class="flex max-h-full flex-shrink-0 flex-col justify-between bg-gray-900/50 p-4 text-gray-300 lg:w-96 lg:p-7">
        <div class="flex flex-1 flex-col gap-y-4">
            ...
            <div class="mt-4 flex items-start justify-between gap-x-4">
                <div>
                    <h2 class="flex items-center gap-x-1 text-sm font-semibold leading-4 text-gray-200">
                ...
                <div
                     class="*:items-center *:justify-center *:text-xs *:font-semibold *:text-white *:border-b *:border-r *:aspect-[3/2] hover:*:bg-gray-600 *:border-gray-600 *:bg-gray-800/50 focus-visible:*:outline-none grid w-[88px] flex-shrink-0 grid-cols-2 items-center overflow-hidden rounded-md border-l border-t border-gray-600">
                    <button class="" type="button">U1</button>
                    <button class="rounded-tr-md" type="button">U2</button>
                    <button class="rounded-bl-md" type="button">U3</button>
                    <button class="rounded-br-md" type="button">U4</button>
                </div>
            </div>
        </div>
